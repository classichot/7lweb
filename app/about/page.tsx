        ...
        <div className="wrap grid-2">
          <div>
            ...
            <div style={{ display: "grid", gap: 0, borderTop: "1px solid var(--line-soft)" }}>
              {["Corporate and personal taxation", "Transfer pricing and international tax", "OECD Pillar Two and global minimum tax", "Forensic accounting and fraud investigation", "Risk, internal audit and compliance", "Corporate, commercial and regulatory law", "Finance leadership, close and cash", "Customs, origin and trade compliance"].map((t) => (
